...
# content_copy
# ). A non-empty tree is represented by a pointer to an object representing its root. The attribute x
# content_copy
#  holds the integer contained in the root, whereas attributes l
# content_copy
#  and r
# content_copy
#  hold the left and right subtrees of the binary tree, respectively.

# For the purpose of entering your own test cases, you can denote a tree recursively in the following way. An empty binary tree is denoted by None
# content_copy
